        ...
        <div className="flex-1 overflow-y-auto mb-16">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-6 gap-1 max-md:gap-1">
              <div 
                className="flex flex-col items-center hover:bg-gray-700/50 rounded-md cursor-pointer transition-colors duration-200 p-2"
                onClick={() => onAppClick('store')}
              >
